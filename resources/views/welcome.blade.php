        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            ...
            <div
                ...
                <div class="flex items-center justify-center h-full w-full p-4">
                        <img src="{{ asset('storage/image/logowates.png') }}" alt="Logo Wates" class="max-h-full max-w-full object-contain transition-all duration-750 opacity-100 starting:opacity-0 scale-125">
                    </div>
